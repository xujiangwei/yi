...
define(function(require, exports, module) {
			...
			(function() {
				var ImageGallery = extend(Gallery, {
							 ...
							 *      item的id对应数据那个属性 2)srcProperty
							 *      String/Function: 图片的src对应数据那个属性
							 *      3)titleProperty String/Function :
							 *      图片的标题对应数据那个属性
							 */
							reader : {},
							...
							onItemRender : function(item, container, id, data,
									isAdd) {
								ImageGallery.superclass.onItemRender.call(this,
										item, container, id, data, isAdd);
								...
								item.el.addClass(this.baseCls + '-image-item')
										.html('<div class='
												+ this.baseCls
												+ '-item-top><img '
