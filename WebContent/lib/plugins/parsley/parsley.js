...
!function ($) {
  ...
  ParsleyUI.prototype = {
    ...
    */
    , ulErrorManagement: function () {
      ...
      this.ulTemplate = $( this.options.errors.errorsWrapper ).attr( 'id', this.hash ).addClass( 'verifier-error-list' );
    }
  ...
  ParsleyField.prototype = {
    ...
    */
    , bindValidationEvents: function () {
      ...
      this.valid = null;
      this.$element.addClass( 'verifier-validated' );
    ...
    */
    , generateHash: function () {
      return 'verifier-' + ( Math.random() + '' ).substring( 2 );
    }
    ...
    * Adds verifier-success or verifier-error class on fields
    *
    ...
    */
    , destroy: function () {
      this.$element.removeClass( 'verifier-validated' );
      this.UI.reset();
  ...
  ParsleyFieldMultiple.prototype = {
    ...
    */
    , initMultiple: function ( element, options ) {
      ...
      this.siblings = this.group ? '[verifier-group="' + this.group + '"]' : 'input[name="' + this.$element.attr( 'name' ) + '"]';
   ...
   , getName: function () {
     if ( this.group ) {
       return 'verifier-' + this.group;
     }

     if ( 'undefined' === typeof this.$element.attr( 'name' ) ) {
       throw "A radio / checkbox input must have a verifier-group attribute or a name to be Parsley validated !";
     }

     return 'verifier-' + this.$element.attr( 'name' ).replace( /(:|\.|\[|\])/g, '' );
   }
  ...
  * =================================================== */
  $( window ).on( 'load', function () {
    $( '[verifier-validate], [data-verifier-validate]' ).each( function () {
      $( this ).parsley();
    } );
  } );
  ...
  */
  $.fn.parsley.defaults = {
    ...
    namespace: 'verifier-'                       // DOM-API, default 'verifier-'. W3C valid would be 'data-verifier-' but quite ugly
    ...
    , successClass: 'verifier-success'           // Class name on each valid input
    , errorClass: 'verifier-error'               // Class name on each invalid input
